    ...
    return (
        <Container className="careerdiv">
            <Row
                ...
                data-aos-offset="0">
                <Col xs={12} md="12">
                    <h2 className="career-text text-center">Job Opportunities</h2>
                </Col>
                <Col xs={12} md="12">
                    <Slider {...settings}>
                            ...
                            return (
                                <Col
                                    ...
                                    <Card className="card-border card1-backgroud-gradient job-slider">
                                        <Card.Body>
                                            <h6 className="title-size">{d.title}</h6>
                                            ...
                                            <Card.Text className="job-muted-size demo">
                                                {d.description}
                                            </Card.Text>
                                        ...
                                        <Row>
                                            <Col xs={24} md={12}>
                                                <Card.Subtitle className="mb-2  job-from-size ">
                                                    <span className="remote-job-size">{d.from}</span>
 
                                                    <Button
                                                        className="card-subtitle-button job-button "
                                                        variant="secondary"
                                                        size="lg"
                                                        onClick={moveFuction}>
                                                        Apply
